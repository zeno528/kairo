...
kairo_register_module network-test system "网络测试" "speedtest backtrace ping_test ip_quality streaming bench"
kairo_register_module docker system "Docker 管理" "list_containers start stop restart logs images"
kairo_register_module bbr system "BBR 加速" "status launch"
kairo_register_module kernel-tune system "内核调优" "status apply restore"
