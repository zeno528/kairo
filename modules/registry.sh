...
kairo_register_module firewall system "防火墙管理" "status open_port close_port allow_ip block_ip enable disable"
...
kairo_register_module network-test system "网络测试" "speedtest backtrace ping_test ip_quality streaming"
kairo_register_module docker system "Docker 管理" "list_containers start stop restart logs images"
kairo_register_module optimize system "网络与BBR内核优化" "status apply restore launch bbrv3"
