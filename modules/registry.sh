...
kairo_register_module network-test network "网络测试" "speedtest backtrace ping_test ip_quality streaming"
kairo_register_module node-quality network "NodeQuality 节点测速" "run"
kairo_register_module ecs-test network "ECS 综合测试" "run"
kairo_register_module ssl-check network "SSL 证书检查" "local_check remote_check batch_check"
...
kairo_register_module 3x-ui proxy "3x-ui 面板" "install status"
kairo_register_module sing-box proxy "sing-box" "install"
