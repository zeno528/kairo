...
## v1.2.54 (2026-08-08)
- ✨ fix(firewall): 初始化防火墙规则计数器以确保状态输出正确

## v1.2.53 (2026-08-08)
- ✨ fix(firewall): 修改规则删除逻辑，允许跳过 SSH 端口 22/tcp 的删除操作

## v1.2.52 (2026-08-08)
- ✨ feat(firewall): 优化防火墙状态输出，支持批量删除规则并修正测试用例

## v1.2.51 (2026-08-08)
- ✨ feat(firewall): 优化防火墙状态输出，增加已放行和未放行状态显示

## v1.2.50 (2026-08-08)
- ✨ feat(firewall): 优化规则显示逻辑，支持 inactive 状态下的规则展示

## v1.2.49 (2026-08-08)
- ✨ fix(firewall): 优化防火墙状态检查逻辑并更新提示信息

## v1.2.48 (2026-08-08)
- ✨ fix(firewall): 修正防火墙状态检查条件以确保准确性

## v1.2.47 (2026-08-08)
- ✨ feat(firewall): 添加防火墙未启用时的提示信息

## v1.2.46 (2026-08-08)
- ✨ feat(firewall): 状态输出优化

## v1.2.45 (2026-08-08)
- ✨ feat(firewall): 状态输出优化

## v1.2.44 (2026-08-08)
- ✨ feat(firewall): 菜单按 ufw 状态显示对应启停入口
  - 根据是否安装及 active/inactive 状态，只展示安装、开启或关闭其中一项，并用红/绿高亮当前可执行动作
  - 补充三种状态的菜单回归测试

## v1.2.43 (2026-08-08)
- ✨ feat(firewall): 新增批量放行未放行监听端口
  - 抽出 _fw_unallowed_listeners 统一计算监听但未放行的端口，状态展示与放行流程复用同一来源
  - 新增 do_allow_listeners 支持编号、范围和全部放行，菜单 [U] 入口接入，二次确认后执行
  - 规则解析放宽以兼容 IP 等非端口条目，并按实际动作动态生成 ALLOW/DENY 图例
  - 优化端口开关的协议选择提示文案
  - 注册 allow_listeners action，补充状态与批量放行回归测试，同步 README

## v1.2.42 (2026-08-08)
- ✨ feat: 优化防火墙状态输出格式，调整未放行端口的显示方式

## v1.2.41 (2026-08-08)
- ✨ feat: 优化防火墙状态输出，增强监听端口信息并更新测试用例

## v1.2.40 (2026-08-08)
- ✨ feat: 添加新加坡部署工作流，并优化防火墙状态输出格式

## v1.2.39 (2026-08-08)
- ✨ feat: 更新防火墙模块，优化端口开放提示信息并添加相应测试

## v1.2.38 (2026-08-08)
- ✨ feat: 更新防火墙模块，自动放行实际 SSH 端口并添加相应测试
...
## v1.2.34 (2026-08-07)
- ✨ feat: 更新端口/任务管理模块，增加 CPU 排行功能并优化内存排行显示

## v1.2.33 (2026-08-07)
- ✨ feat: 添加并配置 Dependabot 以每周更新 GitHub Actions
  ✨ feat: 更新 lint.yml 文件以支持并发执行

## v1.2.32 (2026-08-07)
- ✨ feat: 更新端口/任务管理模块，优化菜单结构和认证状态显示
